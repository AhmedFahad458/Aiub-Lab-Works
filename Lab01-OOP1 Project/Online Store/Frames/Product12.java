...
public class Product12 extends JFrame implements MouseListener,ActionListener
{
	JLabel b2,l2,p2,q1;
	...
	public Product12()
	{
		...
		b2=new JLabel(new ImageIcon("./Images/NarutoSasuke1.jpg"));
		b2.setBounds(100,30,500,500);
		b2.setBackground(Color.BLACK);
		panel.add(b2);
		
		l2=new JLabel("Naruto-Sasuke");
