...
public class Product21 extends JFrame implements MouseListener,ActionListener
{
	JLabel b2,l2,p2,q1;
	...
	public Product21()
	{
		...
		b2=new JLabel(new ImageIcon("./Images/kids-bed1.jpg"));
		b2.setBounds(100,30,500,500);
		b2.setBackground(Color.BLACK);
		panel.add(b2);
		
		l2=new JLabel("Kids bed");
		l2.setBounds(540,140,300,100);
