...
public class Product14 extends JFrame implements MouseListener,ActionListener
{
	JLabel b2,l2,p2,q1;
	...
	public Product14()
	{
		...
		b2=new JLabel(new ImageIcon("./Images/Wallphoto1.jpg"));
		b2.setBounds(100,30,500,500);
		b2.setBackground(Color.BLACK);
		panel.add(b2);
		
		l2=new JLabel("Forest Frame");
