...
public class Product15 extends JFrame implements MouseListener,ActionListener
{
	JLabel b2,l2,p2,q1;
	...
	public Product15()
	{
		...
		b2=new JLabel(new ImageIcon("./Images/Wallphoto2.jpg"));
		b2.setBounds(100,30,500,500);
		b2.setBackground(Color.BLACK);
		panel.add(b2);
		
		l2=new JLabel("Autumn Forest");
		l2.setBounds(510,140,300,100);
		l2.setFont(new Font("Cambria",Font.BOLD,30));
		l2.setOpaque(false);
		panel.add(l2);
		
		p2=new JLabel("4000TK");
		p2.setBounds(550,180,100,100);
